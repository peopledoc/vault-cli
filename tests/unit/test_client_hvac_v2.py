...
def test_get_secret(mock_hvac_v2):
    ...
    mock_hvac_v2.secrets.kv.v2.read_secret.assert_called_with("bla/a", mount_point="bla")
...
def test_list_secrets(mock_hvac_v2):
    ...
    mock_hvac_v2.secrets.kv.v2.list_secrets.assert_called_with("bla/a", mount_point="bla")
...
def test_set_secret(mock_hvac_v2):
    ...
    mock_hvac_v2.secrets.kv.v2.create_or_update_secret.assert_called_with("bla/a", secret={"value": "b"}, mount_point="bla")
